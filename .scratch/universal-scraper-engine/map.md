...
- **Issue 03:** [03-core-engine-implementation.md](issues/03-core-engine-implementation.md) — Status: complete. `crates/workflowd/src/universal_scraper.rs` is `rust-check` green on `5f28b59` (run `34945219044`): formatting clean and `cargo test --workspace --locked` passing, including the 16 offline engine tests.
