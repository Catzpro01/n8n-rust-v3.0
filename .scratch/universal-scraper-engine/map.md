...
- **Issue 02:** [02-node-contract-and-types.md](issues/02-node-contract-and-types.md) — Status: ready (unblocked).
- **Issue 03:** [03-core-engine-implementation.md](issues/03-core-engine-implementation.md) — Status: pending (blocked by 02).
- **Issue 04:** [04-acceptance-test-and-ci.md](issues/04-acceptance-test-and-ci.md) — Status: pending (blocked by 03).
