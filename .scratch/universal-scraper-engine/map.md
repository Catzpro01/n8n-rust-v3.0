...
## Frontier
- **Issue 01:** [01-crate-dependencies.md](issues/01-crate-dependencies.md) â€” Status: in-progress (all 13 crates wired into workflowd; awaiting a green rust-check).
- **Issue 02:** [02-node-contract-and-types.md](issues/02-node-contract-and-types.md) â€” Status: ready (spider, chromiumoxide and polars now pinned for modes 2/3/4).
