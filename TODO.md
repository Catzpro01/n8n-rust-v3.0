...
- [ ] Milestone 3: Workflow & Skill Hub (Scoped package lifecycle, ADR 0060)
- [ ] Milestone 4: AI Agent Platform (Durable Agent Turns & Blueprints, ADR 0061)
- [ ] Milestone 5: Production Upgrade & Recovery (Release slots & drills, ADR 0062)
- [ ] Milestone 6: Large Editor, Compatibility & Release (Production gate, ADR 0063)
