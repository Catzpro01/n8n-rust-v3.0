...
- Committed the resolved decision as `6eb8ae6` and pushed the fixed Arena branch. Push validation `34768305514` and pull-request validation `34768309528` both passed formatting, Rust tests, editor build, and repository tests. The working tree is clean.
